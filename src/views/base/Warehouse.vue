    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border stripe class="table" ref="multipleTable"
                ...
                <el-table-column prop="createdDate" label="更新时间"></el-table-column>
...
import { getWarehouse, getAllUser, updateWarehouse, deleteWarehouse, deleteBatchWarehouse } from "../../api/index";
    ...
    setup() {
        ...
        const deleteBatch = () => {
            ...
            ElMessageBox.confirm("确定要批量删除这些数据吗？", "提示", {
                ...
                deleteBatchWarehouse(ids).then((res) => {
                    if (res) {
                        ElMessage({
                            message: '成功',
                            type: 'success',
