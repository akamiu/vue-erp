    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border stripe class="table" ref="multipleTable"
                ...
                <el-table-column prop="debt" label="负债"></el-table-column>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form label-width="70px">
                ...
                <el-form-item label="负责人">
                    <el-select v-model="form.ownerId" placeholder="" class="handle-select mr10">
                ...
                <el-form-item label="负债">
                    <el-input v-model.number="form.debt"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
...
import { getSupplier, getAllUser, updateSupplier, deleteSupplier, deleteBatchSupplier } from "../../api/index";
    ...
    setup() {
        ...
        const deleteBatch = () => {
            ...
            ElMessageBox.confirm("确定要批量删除这些数据吗？", "提示", {
                ...
                deleteBatchSupplier(ids).then((res) => {
                    if (res) {
                        ElMessage({
                            message: '成功',
                            type: 'success',
